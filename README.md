...
- **`/witness-new`** creates the proposal, design, specs, tasks, and plan. It plans only.
- **`/witness-apply`** implements the plan through test-first slices, review loops, and verification.
- **`/witness-archive`** archives the completed change after its tasks, review, verification, and retrospective are complete.
